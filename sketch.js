...
function spawnEnemys(){
 ...
 // function createArrow() {
  //  arrow= createSprite(steve.x, 100, 5, 10);
   ...
   // return arrow;
 // }
 // function spawnFlippedEnemys(){
   // if(frameCount % 200 === 0)
  
  //  var flippedEnemy = createSprite(1500,600,30,70);
  ...
  //
    //  switch(randomNum){
         // case 1: flippedEnemy.addImage(flippedZombieImg);
        //  break;
         // case 2: flippedEnemy.addImage(flippedZombie2Img);
         // break;
         // case 3: flippedEnemy.addImage(flippedZombie1Img);        
         // break;
        //  //case 4: flippedEnemy.addImage(flippedZombie4Img);
         // break;
         // //case 5: flippedEnemy.addImage(flippedPillagerImg);
         // break;
        //  case 6: flippedEnemy.addImage(flippedRavager1Img);
         // break;
        //  case 7: flippedEnemy.addImage(flippedRavager2Img);
         //break;
         // default: break;
  //    }
     ...
     // enemy.scale = 0.4;
    //  enemy.lifetime = 600;
    //  flippedEnemysGroup.add(flippedEnemy);
  ///}
//
